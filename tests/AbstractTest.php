...
class AbstractTest extends TestCase
{
	 ...
	 */
	public function testObjectGetter(object $object, string $propertyName, string $expectedType)
	{
	 ...
	 * @throws ReflectionException
	 */
	public function testObjectSetter(object $object, string $propertyName, bool $isFluent = true): void
	{
		$class = $this->getClass($object);
	...
	protected function validateValueType($value, string $expectedType = null, string $errorMessage = null): void
	{
		switch($expectedType) {
			...
			default:
				$this->assertInstanceOf($expectedType, $value, $errorMessage);
				break;
		}
	}
